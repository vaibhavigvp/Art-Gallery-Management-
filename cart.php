...
<html>
	<head>
		...
		input[name=cust_bill],input[name=continue],input[name=checkout] {
				border-radius:25px;
                position:relative;
                padding:6px 15px;
			...
			input[name=cust_bill]:hover, input[name=continue]:hover, input[name=checkout]:hover  {
					...
					<br>
						<form action="" method="post" enctype="multipart/form-data">
							...
							<table align="center" width="800" style="margin:auto;" id="outerbox">
								...
								<tr align="center">
									<td colspan="2"><input type="submit" name="cust bill" value="cust bill"></td>
									<td><input type="submit" name="continue" value="Continue"></td>
									<td><a href="generatebill.php"><input type="button" value="Checkout" name="checkout"></a></td>
								</tr>
							</table>
						</form>
